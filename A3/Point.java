...
public final class Point implements Comparable<Point> {
  ...
  /** Compare two points with respect to the slope each makes 
      with this point. */
    ...
    * THIS METHOD IS PROVIDED FOR YOU AND MUST NOT BE CHANGED.
    * 
    * @param obj Object to check for the equality
    ...
    * 
    * @param that Point object for comparison
    * @return some int value
    */
   @Override
   public int compareTo(Point that) {
      int ret = ((Integer)this.y).compareTo(((Integer)that.y));
      if (ret == 0) {
         ret = ((Integer)this.x).compareTo(((Integer)that.x));
      } 
      return ret;
   }    
   ...
   private class ComparePointsBySlope implements Comparator<Point> {
       ...
       * 
       * @param p1 Point object 1 for comparison
       * @param p2 Point object 2 for comparison
       * @return some int value
       */
      @Override   
      public int compare(Point p1, Point p2) {
         return ((Double)(slopeTo(p1))).compareTo((Double)(slopeTo(p2)));
      }
   }
